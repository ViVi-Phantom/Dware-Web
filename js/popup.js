...
function popup1() {
    CreativaPopup.create('DM me if you need help for somethink leakerbydragon &#10084', 'Discord');
}

function popup2() {
    CreativaPopup.create('No Cheeto for you', 'My nigga', 'DWareUD');
}

function popup3() {

    CreativaPopup.create('No Cheeto for you', 'My nigga', 'fruit.png');
}
...
function popup13() {
    CreativaPopup.create('DM me if you need help for somethink  <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#6b05f0">LeakerByDragon</font> &#10084<br> <font style="color: #696969; font-size: smaller;">  <a href="dsc.gg/dwareud</a> </font>', 'Discord', 'dsc.gg/dwareud', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("leakerbydragon");
    setTimeout(function() {
